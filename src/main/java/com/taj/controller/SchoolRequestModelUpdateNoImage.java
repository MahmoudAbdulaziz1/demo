 ...
 */
public class SchoolRequestModelUpdateNoImage {
    ...
    public SchoolRequestModelUpdateNoImage(int request_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "title should have at least 1 characters") String request_title, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "explain should have at least 1 characters") String request_explaination, @NotNull long request_display_date, @NotNull long request_expired_date,
                                           @NotNull @Min(0) int request_is_conformied, @NotNull @Min(1) int school_id, @NotNull String request_category_name, @Min(0) int request_count) {
    ...
    public SchoolRequestModelUpdateNoImage() {
    }
