...
public class NewLoginDto2 {
    ...
    public NewLoginDto2(int login_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 11, message = "email should have at least 2 characters") String user_email, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 8, message = "password should have at least 8 characters") String user_password, @NotNull int is_active, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "role should have at least 1 characters")
    String login_role, long login_date, String login_token, String registration_organization_name, int registration_id) {
    ...
    public NewLoginDto2(int anInt, String string, String resultSetString, int resultSetInt, String s, String string1, String resultSetString1, int i) {
    }
