 ...
 */
public class GetSingleCollectiveByIdPartOneDTO2 {
    ...
    public GetSingleCollectiveByIdPartOneDTO2(int tender_id, String tender_title, String tender_explain,
                                             long tender_display_date, long tender_expire_date, int response_count, List<CategoryNameDto> category) {
    ...
    public GetSingleCollectiveByIdPartOneDTO2() {
    }
