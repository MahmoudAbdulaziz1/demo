 ...
 */
public class MultiCategoryProfileDTOS {
...
//    @Size(max = 450, min = 1, message="youtube should have at least 1 characters")
    ...
    public MultiCategoryProfileDTOS(int company_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "company_name should have at least 1 characters") String company_name, @NotNull String company_logo_image, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "address should have at least 1 characters") String company_address, String company_link_youtube, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "website should have at least 1 characters") String company_website_url, float company_lng, float company_lat, @NotNull String company_cover_image, String company_phone_number, int follower_count, int offer_count, String company_desc, int company_cat_id, String company_cat_name) {
    ...
    public MultiCategoryProfileDTOS() {
    }
    ...
    public int getCompany_cat_id() {
        return company_cat_id;
    }

    public void setCompany_cat_id(int company_cat_id) {
        this.company_cat_id = company_cat_id;
    }

    public String getCompany_cat_name() {
        return company_cat_name;
    }

    public void setCompany_cat_name(String company_cat_name) {
        this.company_cat_name = company_cat_name;
    }
}
