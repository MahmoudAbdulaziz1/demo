 ...
 */
public class UpdateSchoolProfilModel {
...
//    @Size(max = 450, min = 1, message="company_name should have at least 1 characters")
    ...
    public UpdateSchoolProfilModel() {
    }

    public UpdateSchoolProfilModel(@Min(1) int school_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "name should have at least 1 characters") String school_name, String school_logo_image, String school_cover_image, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "address should have at least 1 characters") String school_address, String school_service_desc, String school_link_youtube,
                                   String school_website_url, float school_lng, float school_lat, @NotNull String school_phone_number, String area, String city, float lng, float lat) {
