 ...
 */
public class SchoolRequestNewDtoModel {
    ...
    public SchoolRequestNewDtoModel(int request_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "title should have at least 1 characters") String request_title, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "explain should have at least 1 characters") String request_explaination, @NotNull long request_display_date,
                                    @NotNull long request_expired_date, int request_count, int school_id, @NotNull String request_category_name, @NotNull int response_count) {
    ...
    public SchoolRequestNewDtoModel() {
    }
