...
public class AdminSingleOrderHistoryModel {
    ...
    public AdminSingleOrderHistoryModel(int offer_id, String offer_image, String offer_title, String offer_explaination, long offer_display_date, long offer_expired_date,
                                        long offer_deliver_date, int request_offer_count, int school_id, String school_logo_image, int company_id,
    ...
    public AdminSingleOrderHistoryModel(String offer_image, String offer_title, String offer_explaination, long offer_display_date, long offer_expired_date,
                                        long offer_deliver_date, int request_offer_count, int school_id, String school_logo_image, int company_id,
                                        double offer_cost, String company_logo_image, double ship) {
        this.offer_image = offer_image;
        this.offer_title = offer_title;
