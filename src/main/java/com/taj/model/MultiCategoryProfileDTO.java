 ...
 */
public class MultiCategoryProfileDTO {
...
//    @Size(max = 450, min = 1, message="youtube should have at least 1 characters")
    ...
    public MultiCategoryProfileDTO(int company_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "company_name should have at least 1 characters") String company_name, @NotNull String company_logo_image, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "address should have at least 1 characters") String company_address, String company_link_youtube, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "website should have at least 1 characters") String company_website_url, float company_lng, float company_lat, @NotNull String company_cover_image, String company_phone_number, int follower_count, int offer_count, String company_desc, List<TakatfTenderCategoryPOJO> category) {
    ...
    public MultiCategoryProfileDTO(@NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "company_name should have at least 1 characters") String company_name, @NotNull String company_logo_image, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "address should have at least 1 characters") String company_address, String company_link_youtube, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "website should have at least 1 characters") String company_website_url, float company_lng, float company_lat, @NotNull String company_cover_image, String company_phone_number, int follower_count, int offer_count, String company_desc, List<TakatfTenderCategoryPOJO> category) {
        this.company_name = company_name;
        this.company_logo_image = company_logo_image;
        this.company_address = company_address;
        this.company_link_youtube = company_link_youtube;
    ...
    public MultiCategoryProfileDTO() {
    }
