 ...
 */
public class GetCollectiveTenderPartOneDTO2 {
    ...
    public GetCollectiveTenderPartOneDTO2(int request_id, String request_title,
                                          String request_explaination, long request_display_date, long request_expired_date, int school_id, int response_count, byte[] image_one) {
    ...
    public GetCollectiveTenderPartOneDTO2() {
    }
