...
//    @Size(max = 450, min = 1, message="company_name should have at least 1 characters")
    ...
    public SchoolProfileModel(int school_id, String school_name, String school_logo_image, String school_address,
    ...
    public SchoolProfileModel(String school_name, String school_logo_image, String school_address,
                              String school_service_desc, String school_link_youtube, String school_website_url, float school_lng,
                              float school_lat, String school_cover_image, String school_phone_number) {
        this.school_name = school_name;
        this.school_logo_image = school_logo_image;
