 ...
 */
public class SchoolOrdersModel {
    ...
    public SchoolOrdersModel(int request_id, double responsed_cost, long response_date, String response_desc, long request_display_date,
