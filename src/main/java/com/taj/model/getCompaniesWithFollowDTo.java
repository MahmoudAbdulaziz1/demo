 ...
 */
public class getCompaniesWithFollowDTo {
...
//    private int offer_count;
    ...
    public getCompaniesWithFollowDTo(int company_id, @NotNull @NotBlank
...
//        this.offer_count = offer_count;
    ...
    public getCompaniesWithFollowDTo(@NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "company_name should have at least 1 characters") String company_name,
...
//        this.offer_count = offer_count;
    ...
    public getCompaniesWithFollowDTo() {
    }
