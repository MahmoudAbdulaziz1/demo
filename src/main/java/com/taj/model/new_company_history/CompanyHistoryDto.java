...
public class CompanyHistoryDto {
    ...
    public CompanyHistoryDto(int offer_id, String image_one, String image_two, String image_three, String image_four, String offer_title, String offer_explaination, double offer_cost, long offer_display_date,
                             long date, int offer_count, String city, String area, float lng, float lat, int request_id, int requsted_school_id, int request_offer_count, int request_count) {
