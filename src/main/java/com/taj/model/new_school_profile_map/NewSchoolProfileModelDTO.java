 ...
 */
public class NewSchoolProfileModelDTO {
...
//    @Size(max = 450, min = 1, message="company_name should have at least 1 characters")
    ...
    public NewSchoolProfileModelDTO(@Min(1) int school_id, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "name should have at least 1 characters")
    String school_name, @NotNull String school_logo_image, @NotNull @NotBlank @NotEmpty @Size(max = 450, min = 1, message = "address should have at least 1 characters")
    String school_address, String school_service_desc, String school_link_youtube, String school_website_url,
                                    float school_lng, float school_lat, @NotNull String school_cover_image, String school_phone_number, String city, String area, float lng, float lat) {
